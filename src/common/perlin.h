...
inline vec3 *perlin::ranvec = perlin_generate();

inline int *perlin::perm_x = perlin_generate_perm();
inline int *perlin::perm_y = perlin_generate_perm();
inline int *perlin::perm_z = perlin_generate_perm();
